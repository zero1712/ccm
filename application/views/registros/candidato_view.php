...
//]]>
    ...
    function InitComponents(){
      ...
      function cargarRegistros(){
        $("#Alumnos").ajaxSorter({
        url:'<?php echo base_url();?>index.php/registros/getRegistrosAprobacion',
        multipleFilter:true, 
        filters:['carreras'], 
        paginator:true  , 
            onRowClick:function(){
            ...
            success: function(){
                    ...
                    $("#status").append("<option value=' '>Seleccione: </option> <option value='Atendido'> Atendido</option> <option value='1'> Aprobado</option> <option value='2'> No aprobado</option>   ");	
        ...
        if(opc==0){
            $("#StatusSelect").dialog({
                ...
                buttons:[{
                    ...
                    click:function(){
                      $.ajax({
            url: "<?php echo base_url();?>index.php/registros/Aprobar",
            type: "POST",
            data:{
                    id: $("#txtId").val()
            },
            success: function(data){
                alert("Hecho!");
                    ...
                    click:function(){
                         $.ajax({
            url: "<?php echo base_url();?>index.php/registros/NoAprobar",
            type: "POST",
            data:{
                    id: $("#txtId").val()
            },
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Consulta de peticionarios <small>Control</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                 ...
                 <div class="form-group">
                                ...
                                <select class="form-control"  id="txtPrioridad" name="txtPrioridad" readonly>
