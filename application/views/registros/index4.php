...
//]]>
    ...
    function InitComponents(){
      ...
      function cargarRegistros(){
        ...
        $("#Alumnos").ajaxSorter({
        url:'<?php echo base_url();?>index.php/registros/getRegistros',
        multipleFilter:true, 
        filters:['carreras'], 
        paginator:true  , 
          onRowClick:function(){
            ...
            success: function(){
                    ...
                    $("#status").append("<option value=' '>Seleccione: </option> <option value='Contactado'> Contactado</option> <option value='N/A'> N/A</option>   ");	
...
<body>
<?php if($this->session->userdata("admin_login") and $this->session->userdata("admin_login")->privilegio == 1){?>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="<?php echo base_url();?>index.php/registros/goPeticionarios"><i class="fa fa-fw fa-dashboard"></i> Peticionarios</a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Registros de Peticionarios <small>PostContact</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
