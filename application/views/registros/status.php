...
//]]>
    ...
    function InitComponents(){
      ...
      function cargarRegistros(){
        $("#Alumnos").ajaxSorter({
        url:'<?php echo base_url();?>index.php/registros/getRegistrosStatus',
        multipleFilter:true, 
        filters:['carreras'], 
        paginator:true  , 
            onRowClick:function(){
                ...
                alert("Hecho!");
                    ...
                    click:function(){
                     ...
                     if (confirm('El campo status es Atendido, si continua la peticion cambiara al modulo de Atendidos\n ¿Desea continuar?')) { 
                           ...
                           if(($("#status option:selected").text())=="En tramite"){
                        
                     if (confirm('El campo status es en tramite, si continua la peticion cambiara al modulo de En tramite\n ¿Desea continuar?')) { 
                                $("#formulario").submit();
                                                                                                                            }
                                                                        }
                       }
...
<body>
<?php if($this->session->userdata("admin_login") and $this->session->userdata("admin_login")->privilegio == 2){?>
    <div id="wrapper">

        <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <!-- Brand and toggle get grouped for better mobile display -->
            <div class="navbar-header" style="background-image: url(<?php echo base_url();?>assets/images/logobar.png);  height: 45px; width: 120px;">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                 ...
                 <li >
                        <a href="<?php echo base_url();?>index.php/registros/goAddPeticionario1"><i class="fa fa-fw fa-table"></i> Registro</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Consulta de peticionarios <small>Gestión</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
    ...
    <div  class="container_6 mifondo" id="StatusSelect">
        <form enctype="multipart/form-data" id="formulario" name="formulario" class="EnviarFragmentos" method="post">
            ...
            <div class="form-group">
                <label>Nombre(s):</label>
                 <input class="form-control"  type="text" id="txtNombres"  name="txtNombres" style="display:block;" onkeypress="return soloLetras(event);" onkeyup="aMays(event, this)" onblur="aMays(event, this)">
            </div>
                <div class="form-group">
                <label>Apellido paterno:</label>
                <input  class="form-control" type="text" id="txtApellidop" name="txtApellidop" style="display:block;" onkeypress="return soloLetras(event);" onkeyup="aMays(event, this)" onblur="aMays(event, this)">
            </div>
                <div class="form-group">
            ...
            <div class="col-lg-6">
                ...
                <label>Apellido materno:</label>
                 <input class="form-control"  type="text" id="txtApellidom"  name="txtApellidom" style="display:block;" onkeypress="return soloLetras(event);" onkeyup="aMays(event, this)" onblur="aMays(event, this)" >
            </div>
            <div class="form-group">
            ...
            <label>Observaciones: </label>
                                <textarea id="txtObservaciones" name="txtObservaciones" class="form-control" rows="4" onkeyup="aMays(event, this)" onblur="aMays(event, this)"></textarea>
                            </div>
...
<div width="100%" id="map"></div>
        ...
        <form enctype="multipart/form-data" id="formularioPostContact" name="formularioPostContact" class="EnviarPostContact" method="post">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                <label>Nombre(s):</label>
                <input class="form-control" type="text" name="txtNombre" readonly="readonly" id="txtNombre" onkeyup="aMays(event, this)" onblur="aMays(event, this)">
            </div>
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="txTClveElect" id="txTClveElect" onkeyup="aMays(event, this)" onblur="aMays(event, this)">
            </div>
               <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="txtDireccion" id="txtDireccion" placeholder="Calle/Numero" onkeyup="aMays(event, this)" onblur="aMays(event, this)">
            </div>
        
            <div class="form-group">
                <label>Colonia:</label>
                <input class="form-control" type="text" name="txtColonia"  id="txtColonia" onkeyup="aMays(event, this)" onblur="aMays(event, this)">
            </div>
            <div class="form-group">
                <label>Correo Electrónico:</label>
                <input class="form-control" type="email" name="email" id="email" onkeyup="aMays(event, this)" onblur="aMays(event, this)">
            </div>
            <div class="form-group">
