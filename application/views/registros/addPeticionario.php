...
<body onload="init()">
<?php if($this->session->userdata("admin_login") and (($this->session->userdata("admin_login")->privilegio == 1) or ($this->session->userdata("admin_login")->privilegio == 2))){?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            Agregar Peticionarios<small> PostContact</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                 ...
                 <div class="form-group">
                         ...
                         <div class="form-group">
                                            ...
                                            <input type="text" id="form_telefono"  size="10" onkeypress="return justNumbers(event);" name="form_telefono" class="form-control" required/>
